...
<div class="caption">
  ...
  {#if activeIndex > 0}
    <p>
      ...
      { (data[activeIndex].population - data[activeIndex - 1].population) / data[activeIndex - 1].population * 100 }%
      compared with the population 10 years earlier; and a
      { (data[activeIndex].population - data[0].population) / data[0].population * 100 }% increase
