...
<div class="graph">
  ...
  <div class="main-chart">
    ...
    <svg id="chart" width="900" height="600">
      <g>
        <text class="graph-text" x={yearXPosition} y={yPosition} dominant-baseline="hanging">{yearLabel}</text>
        <text class="graph-text" x={separatorXPosition} y={yPosition} dominant-baseline="hanging">–</text>
        <text class="graph-text" x={populationXPosition} y={yPosition} dominant-baseline="hanging" text-anchor="end">
          {populationLabel}
        </text>
        <rect class="bar" x={barXPosition} y={yPosition} height={barHeight} width={barWidth} />
      </g>
      </svg>
  </div>
</div>
